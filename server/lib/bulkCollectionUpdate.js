 ...
 * @desc insert/update the whole content of a collection with the content of an array
 **/
...
export const bulkCollectionUpdate = function ( collection, data, options ) {
  // set defaults
  options = options || {};
  ...
  if (typeof options.primaryKey !== "string" || (data.length && typeof data[0][options.primaryKey] !== "string")) {
