Template.AgendaSop.onCreated(function() {
	
});

Template.AgendaSop.onDestroyed(function() {
	
});

Template.AgendaSop.onRendered(function() {
...
Template.AgendaSop.events({
	
});

Template.AgendaSop.helpers({
...
Template.agenda_sop.helpers({	
});

Template.agenda_sop.onCreated(function () {
  var template = Template.instance();
  template.subscribe('aop_agenda_list');
});

Template.agenda_sop.onRendered(function () {
...
Template.addEditEventSopModal.helpers({
...
Template.addEditEventSopModal.events({
